...
?>
           ...
           <div id="izquierda" style="margin-left:20%;width:25%;height:auto;float:left;">
              ...
              <div class="form-group">
                <label>Cod.Autor</label>
                  ...
                  <input type="number" class="form-control" name="cod_autor">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                <label>Cod.Discográfica</label>
                  ...
                  <input type="number" class="form-control" name="cod_discogra">
    ...
    $connection2 = new mysqli("localhost", "root", "zombiejd93", "tienda_musica");
       ...
       if ($connection2->connect_errno) {
        ...
        $result2 = $connection2->query("INSERT INTO DISCO (TITULO,GENERO,FECHA,CARATULA,PRECIO,COD_DISCOGRA,COD_AUTOR) VALUES ('$titulo2','$genero2','$fecha2','$caratula2','$precio2','$cod_discogra2','$cod_autor2')");
